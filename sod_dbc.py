...
def emit_spell_sql(spells, cols, module, retired_ids=None):
    ...
    spell_script_names + spell_bonus_data + spell_proc, each with a scoped
    idempotent DELETE. `module` is the folder name (e.g. mod-sod-mage) used in
    comments. `retired_ids` are ids this module used to ship and now cleans out."""
